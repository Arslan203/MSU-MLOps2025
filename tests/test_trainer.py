...
class TestTrainEpoch:
    ...
    def test_train_epoch_returns_loss(
        self, dummy_model, dummy_dataloader, dummy_optimizer, dummy_loss_fn
    ):
        ...
        loss = train_epoch(
            dummy_model, dataloader, dummy_optimizer, dummy_loss_fn, device
        )

        assert isinstance(loss, float)
        assert loss >= 0

    def test_train_epoch_updates_model(
        self, dummy_model, dummy_dataloader, dummy_optimizer, dummy_loss_fn
    ):
...
class TestValidateEpoch:
    ...
    def test_validate_epoch_returns_metrics(
        self, dummy_model, dummy_dataloader, dummy_loss_fn
    ):
        ...
        val_loss, val_rmse, val_mae = validate_epoch(
            dummy_model, dataloader, dummy_loss_fn, device
        )
