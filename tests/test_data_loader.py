...
class TestCalculateReviewStatistics:
    ...
    def test_calculate_statistics(self):
        ...
        reviews = pd.DataFrame({"RecipeId": [1, 1, 2, 2, 2], "Rating": [4, 5, 3, 4, 5]})
...
class TestPrepareTextFeatures:
    ...
    def test_prepare_text_features(self):
        ...
        data = pd.DataFrame({"ingredients": ["apple banana", "cherry", None, "orange"]})
...
class TestSplitData:
    ...
    def test_split_data(self):
        ...
        numerical_features = pd.DataFrame(
            {"minutes": [30, 60, 90, 120], "n_steps": [5, 10, 15, 20]}
        )
